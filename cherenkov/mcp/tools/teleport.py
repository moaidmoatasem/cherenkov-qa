...
def register_teleport_tools(mcp: FastMCP) -> None:
    """Register session teleport tools with a FastMCP server instance.

    Args:
        mcp (FastMCP): FastMCP server instance to register tools on.
    ...
    def teleport_push(session_id: str, state_data_json: str) -> str:
        ...
        Args:
            ...
            state_data_json (str): JSON string containing session state data.

        Returns:
            str: Token status string or error message.
        """
        try:
    ...
    def teleport_pull(token_str: str) -> str:
        ...
        Returns:
            str: Serialized JSON state data string or error message.
        """
