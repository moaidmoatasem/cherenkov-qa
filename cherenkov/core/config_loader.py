...
PROFILE_DEFAULTS: dict[str, dict[str, Any]] = {
    "laptop": {
        ...
        "substrate.tiers.vision.provider": "ollama",
        "substrate.tiers.vision.model": "qwen2.5-vl:7b",
    ...
    "frontier-cloud": {
        ...
        "substrate.tiers.vision.provider": "openai",
        "substrate.tiers.vision.model": "gpt-4o",
...
BUILTIN_DEFAULTS: dict[str, Any] = {
    ...
    "certification.gold_set_path": ".cherenkov/gold_set.json",
    "certification.min_faithfulness": 0.8,
    "copilot.autonomy": "assisted",
    "copilot.mentor_enabled": True,
}
...
class LayeredConfig:
    ...
    def load_env(self):
        ...
        env_map = {
            ...
            "CHERENKOV_TIER_DEEP_PROVIDER": "substrate.tiers.deep.provider",
            "CHERENKOV_TIER_DEEP_MODEL": "substrate.tiers.deep.model",
            "CHERENKOV_TIER_VISION_PROVIDER": "substrate.tiers.vision.provider",
            "CHERENKOV_TIER_VISION_MODEL": "substrate.tiers.vision.model",
            "CHERENKOV_PROFILE": "profile",
            "CHERENKOV_MODE": "continuity.mode",
        }
