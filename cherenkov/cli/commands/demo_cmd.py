"""cherenkov/cli/demo_cmd.py — CLI command module."""
...
def test_create_user_strict(base_url: str) -> tuple[bool, str]:
    """Execute the CLI test create user strict command.

Args:
    base_url (str): Parameter base_url.

Returns:
    tuple[bool, str]: Command execution result.
    """
...
def test_create_user_weakened(base_url: str) -> tuple[bool, str]:
    """Execute the CLI test create user weakened command.
...
def test_create_order_strict(base_url: str) -> tuple[bool, str]:
    """Execute the CLI test create order strict command.
