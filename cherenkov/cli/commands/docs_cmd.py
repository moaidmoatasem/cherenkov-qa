...
class Topic(TypedDict):
    """Typed dictionary structure representing a documentation topic.

    Attributes:
        summary: Short one-line summary of the topic.
        commands: Example CLI commands associated with the topic.
        notes: Key operational guidance and architectural notes.
    """
    summary: str
    commands: list[str]
    notes: list[str]
...
Args:
    topic: Name of documentation topic, or None to list all topics.
    as_json: True to emit structured JSON output.
