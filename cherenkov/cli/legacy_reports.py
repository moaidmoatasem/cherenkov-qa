...
def print_visual_report(target_url: str, reports) -> None:
    """Print human-readable visual regression report to console.

    Args:
        target_url (str): Target application URL verified.
        reports: List of visual inspection report items.
...
def print_perf_report(target_url: str, reports) -> None:
    """Print human-readable performance baseline report to console.

    Args:
        target_url (str): Target application URL verified.
        reports: List of performance inspection report items.
