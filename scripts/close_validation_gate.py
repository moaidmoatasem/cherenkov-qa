#!/usr/bin/env python3
"""Script to comment on and close GitHub validation gate issues."""
import json
import os
import sys
import urllib.error
...
def post_comment_and_close(issue_num, comment_body):
    """Post a closing comment and close the specified GitHub issue.

    Args:
        issue_num: GitHub issue number integer.
        comment_body: Comment body text string to post.
    """
    # 1. Post comment
...
def main():
    """Main entry point to post comments and close validation gate issues."""
    tasks = {
