"""Script to post closing comments and close completed GitHub issues."""
import json
import os
import sys
import urllib.error
...
def post_comment_and_close(issue_num: int, comment_body: str) -> None:
    """Post closing comment to GitHub issue and mark it closed.

    Args:
        issue_num: Issue number integer.
        comment_body: Body text of comment to post.
...
def main() -> None:
    """Close batch of completed GitHub issues with resolution summary.
