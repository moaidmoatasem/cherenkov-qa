...
def regenerate() -> tuple[dict, dict]:
    ...
    Returns:
        Tuple of manifest dictionary and mcp_json dictionary.
    """
...
def main() -> int:
    """Main CLI entry point for regenerating MCP registry artifacts.

    Returns:
        Exit code integer (0 on success, 1 on drift check failure).
    """
