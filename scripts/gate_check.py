"""Script to inspect validation evidence ledger and verify gate pass conditions."""
import os
import sys
...
def check_gate():
    ...
    evidence_dir = os.path.join(
        os.path.dirname(__file__), "..", "docs", "process", "evidence"
    )
    has_mobile = False
    has_chat = False
    ...
    if yes_count >= 5 and has_mobile and has_chat:
        ...
        print(
            "GATE OPEN: Conditions not met. Need >= 5 'Yes' verdicts, including 1 mobile and 1 chat."
        )
        sys.exit(1)
