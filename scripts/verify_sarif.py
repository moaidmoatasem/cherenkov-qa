"""Verification script for SARIFEmitter schema compliance."""
import json
import sys
...
class MockFinding:
    """Mock finding object representing a single API divergence finding.

    Args:
        violation_type: Type of violation (e.g. status_mismatch).
        severity: Severity level string (e.g. high, medium).
...
class MockReport:
    """Mock report object holding a list of findings.

    Args:
        findings: List of MockFinding instances.
    """
