"""Script to generate default PNG and ICO icons for Tauri desktop build."""
import os
...
def generate_icons():
    """Generate PNG and ICO icon assets for desktop application bundle."""
    ...
    for r in range(160, 0, -4):
        alpha = int((160 - r) * 1.5)
        draw.ellipse(
            [(256 - r, 256 - r), (256 + r, 256 + r)], fill=(0, 240, 255, alpha)
        )
