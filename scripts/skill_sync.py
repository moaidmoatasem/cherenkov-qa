...
def main() -> None:
    """Validate skill file synchronization between CHERENKOV and Qwen Code ecosystems.

    Checks that all required skill definition files in `.qwen/skills/` exist and correctly
    map to their corresponding Markdown skill specifications under `skills/`.

    Raises:
        SystemExit: With exit code 1 if missing skills or unmapped files are detected,
            or 0 if all skills are harmonized.
    """
