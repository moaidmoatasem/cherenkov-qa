...
5. [Phase -1 — Planning & Preparation](#phase-1-planning-preparation-days-1-2)
6. [Phase 0a — P0 Bug Fixes](#phase-0a-p0-bug-fixes-days-3-5)
7. [Phase 0b — Foundations](#phase-0b-foundations-week-2)
8. [Phase 1 — Second Brain](#phase-1-second-brain-weeks-3-5)
9. [Phase 2 — VLM + LocalAI](#phase-2-vlm-localai-github-models-weeks-3-4-parallel-with-phase-1)
10. [Phase 3 — Desktop Host](#phase-3-desktop-host-weeks-5-8)
11. [Phase 4 — Chat Agents](#phase-4-chat-agents-weeks-9-10)
12. [Phase 5 — Mobile Testing Core](#phase-5-mobile-testing-core-weeks-5-10-parallel-tail)
13. [Phase 6 — Mobile Execution](#phase-6-mobile-execution-weeks-11-14)
14. [Phase 7 — Dashboard Revamp](#phase-7-dashboard-revamp-weeks-14-16)
15. [Phase 8 — K8s + Cloud + Gate](#-phase-8-k8s-cloud-validation-gate-weeks-16-20-complete)
16. [Agent Guidance](#agent-guidance)
