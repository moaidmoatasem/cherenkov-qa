...
[HANDOVER.md §5](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md)).
...
> open for development. See [HANDOVER.md §5](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md) for details.
