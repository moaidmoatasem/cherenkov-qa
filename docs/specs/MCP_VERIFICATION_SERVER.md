...
> **Why:** the highest-leverage interoperability bet — make CHERENKOV the *verify* step every coding agent reaches for before claiming "done." See [../NORTH_STAR.md](../NORTH_STAR.md) §6, [../PRODUCT_STRATEGY_ROADMAP.md](../ROADMAP.md) E2.1.
> **Date:** 2026-06-16
