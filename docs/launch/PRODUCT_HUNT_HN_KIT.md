...
>
> Today, with our v1.2.0 release, CHERENKOV officially supports REST, GraphQL, gRPC (via Buf), and AsyncAPI/WebSockets. It even exports Jira tickets automatically on pipeline failure.
>
