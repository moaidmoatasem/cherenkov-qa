...
This document serves as the architectural blueprint for the official CHERENKOV Discord server. As we launch v1.2.0 and step into the Reality Engine phase, cultivating a technical, high-signal community is paramount.
...
- **Early Adopter**: Special vanity role given to the first 500 members to join after the v1.2.0 launch. (Color: Purple #9b59b6)
