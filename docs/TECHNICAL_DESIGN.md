...
**Authority:** [docs/STATUS.md](STATUS.md) · [docs/PHASE_PLAN.md](PHASE_PLAN.md) · [docs/HANDOVER.md](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md) · **For:** Core Architecture
