...
> **Authoritative handover is the repo-root [`HANDOVER.md`](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md).**
...
- **Integrity Status**: Full test suite passes completely (2076 passed) — *superseded 2026-08-04: re-certified 2138 passed / 2 failed (network-only real_demo) / 6 skipped at `530468a1`, see root [`HANDOVER.md`](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md)*. Production build succeeds with 0 tsc errors.
...
[AGENTS.md](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/AGENTS.md)). All code now lives under `cherenkov/` and the
relevant subfolders.
...
> **Canonical status lives in the repo-root [`HANDOVER.md`](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md).** This file does
...
- Track B/C + Horizon 2: **built, unit-tested, re-integrated** into the live tree
  (`track-b-c-deferred/` was deleted; see [AGENTS.md](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/AGENTS.md)).
...
3. **[root `HANDOVER.md`](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md)** — the canonical status anchor.
...
- Full roadmap → **[docs/PRODUCT_STRATEGY_ROADMAP.md](../../ROADMAP.md)**
