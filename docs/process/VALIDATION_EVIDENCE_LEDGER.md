...
> **Authority:** This ledger tracks attributable evidence; [STATUS.md](../STATUS.md) and [HANDOVER.md](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md) are the SSOT for gate status.
...
4. Update the **Tally** line and, once ≥3 Yes, flip **Status** at the top to PASSED and
   update [HANDOVER.md](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md) in the same commit.
