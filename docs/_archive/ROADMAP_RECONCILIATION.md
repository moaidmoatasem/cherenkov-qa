...
> [HANDOVER.md §2](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md) explicitly warns about.
>
> **The authoritative SSOT is [HANDOVER.md](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/HANDOVER.md) + [AGENTS.md](https://github.com/moaidmoatasem/cherenkov-qa/blob/main/AGENTS.md):
