...
def main() -> int:
    ...
    for item in [
        HitlItem(
            ...
            method="GET",
            confidence=0.78,
            confidence_reason="Accepted invalid status",
        ...
        HitlItem(
            ...
            method="GET",
            confidence=0.65,
            confidence_reason="404 body missing",
        ...
        HitlItem(
            ...
            method="POST",
            confidence=0.92,
            confidence_reason="Unexpected status",
            review_gate_failed="gate_quality",
            run_id="r1",
        ),
    ]:
        q.enqueue(item)
    ...
    r = client.post(
        "/api/v1/review/reject", json={"scenario_id": "g2", "reason": "Intended"}
    )
    ...
    r = client.post(
        ...
        json={"item_id": "g3", "classification": "regression"},
    )
    ...
    r = client.post(
        "/api/v1/review/edit",
        json={"scenario_id": "golden_edit", "test_code": "// test\n"},
    )
    c["edit: 200"] = r.status_code == 200

    r = client.post(
        "/api/v1/divergences/act",
        json={"divergence_id": "D-01", "action": "close_with_test"},
    )
