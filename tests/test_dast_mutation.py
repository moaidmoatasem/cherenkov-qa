...
from cherenkov.stages.ingest import IngestStage, DAST_PAYLOADS
from cherenkov.core.contracts import Mutation
    ...
    def test_security_mutations_not_emitted_when_disabled(self):
        with patch.object(cherenkov.core.config.Config, "DAST_ENABLED", False):
            ...
            try:
                ...
                ep = output.endpoints[0]
                security_muts = [m for m in ep.mutations if m.case_type == "security"]
                self.assertEqual(len(security_muts), 0,
    ...
    def test_security_mutations_per_string_field(self):
        with patch.object(cherenkov.core.config.Config, "DAST_ENABLED", True):
            ...
            try:
                ...
                self.assertEqual(len(security_muts), 2 * expected_per_field,
