            ...
            "types": [
                {
                    ...
                    "fields": [
                        ...
                        {"name": "users", "args": [{"name": "first", "type": {"kind": "SCALAR", "name": "Int"}}, {"name": "after", "type": {"kind": "SCALAR", "name": "String"}}]}
                    ]
                },
                {
                    "kind": "OBJECT",
                    "name": "Mutation",
                    "fields": [
                        {"name": "createUser", "args": [{"name": "input", "type": {"kind": "NON_NULL", "ofType": {"kind": "INPUT_OBJECT", "name": "CreateUserInput"}}}]},
                        {"name": "updateUser", "args": [{"name": "id", "type": {"kind": "NON_NULL", "ofType": {"kind": "SCALAR", "name": "ID"}}}, {"name": "input", "type": {"kind": "NON_NULL", "ofType": {"kind": "INPUT_OBJECT", "name": "UpdateUserInput"}}}]}
                    ]
                },
                {
                    "kind": "OBJECT",
...
class TestGraphQLScenarioPlanner(unittest.TestCase):
    ...
    def test_scenario_structure(self):
        ...
        for s in scenarios:
            ...
            self.assertIn(s.scenario_type, ['happy_path', 'null_fields', 'pagination', 'error', 'auth'])
