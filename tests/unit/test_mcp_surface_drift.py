...
def test_query_rag_tool_returns_ok_not_error(monkeypatch):
    """Placeholder docstring.
...
"""
    ...
    # RAGIndex is mocked to avoid real SQLite I/O on WSL network paths.
    class _FakeRAGIndex:
        def query_similar_incidents(self, *_a, **_kw):
            return []

    monkeypatch.setattr(
        "cherenkov.knowledge.rag_index.RAGIndex", _FakeRAGIndex
    )
