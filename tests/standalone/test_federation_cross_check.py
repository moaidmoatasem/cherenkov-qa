...
def test_schema_drift():
    ...
    node_a = make_endpoint_node(
        "GET", "/users", response_status="200", response_content_type="application/json"
    )
    node_b = make_endpoint_node(
        "GET", "/users", response_status="200", response_content_type="text/plain"
    )
