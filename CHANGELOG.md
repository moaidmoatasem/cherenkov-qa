...
## [1.4.0](https://github.com/moaidmoatasem/cherenkov-qa/compare/v1.3.0...v1.4.0) (2026-09-15)
...
* clear the three pre-existing CI failures — soc2 date crash, hook bytes/str, docs link ([#1021](https://github.com/moaidmoatasem/cherenkov-qa/issues/1021)) ([a61fa9b](https://github.com/moaidmoatasem/cherenkov-qa/commit/a61fa9bfd5586a7721ab0fc158883181f73add17))
...
* enterprise proxy/error-message/storage crash bugs found by exploratory E2E pass ([#1023](https://github.com/moaidmoatasem/cherenkov-qa/issues/1023)) ([45a766c](https://github.com/moaidmoatasem/cherenkov-qa/commit/45a766cd87beb7af0f4f40715eed5c6a84d31396))
...
* Mobile Pilot Start is no longer a one-way door ([#1024](https://github.com/moaidmoatasem/cherenkov-qa/issues/1024)) ([123775c](https://github.com/moaidmoatasem/cherenkov-qa/commit/123775c7b4a643a11b4d86aaaa5ad3b2f2da1281))
...
* repair the first-run path — verdict scope, directory input, .skip blind spot, UI dead end ([#1012](https://github.com/moaidmoatasem/cherenkov-qa/issues/1012)) ([13d938c](https://github.com/moaidmoatasem/cherenkov-qa/commit/13d938c3d65edda2d43c99c5dc72b44417caec3f))
...
* wire the real-backend dashboard E2E suite into CI, fix HITL review queue test ([#1027](https://github.com/moaidmoatasem/cherenkov-qa/issues/1027)) ([2b778ce](https://github.com/moaidmoatasem/cherenkov-qa/commit/2b778ce87a9585668c17ad6d843b0f138d3969dd))
